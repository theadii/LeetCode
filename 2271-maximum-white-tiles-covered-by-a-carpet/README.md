<h2><a href="https://leetcode.com/problems/maximum-white-tiles-covered-by-a-carpet">2359. Maximum White Tiles Covered by a Carpet</a></h2><h3>Medium</h3><hr><p>You are given a 2D integer array <code>tiles</code> where <code>tiles[i] = [l<sub>i</sub>, r<sub>i</sub>]</code> represents that every tile <code>j</code> in the range <code>l<sub>i</sub> &lt;= j &lt;= r<sub>i</sub></code> is colored white.</p>
